...
Array<int64_t> BatchPagedAttentionPlan(TensorView float_workspace_buffer,
  ...
  DISPATCH_context(
      ...
      AttentionVariant, PersistentParams, [&] {
        ...
        auto kernel =
            GetBatchPagedAttentionPersistentKernel<CTA_TILE_Q_1_DEFAULT, CTA_TILE_Q_2_DEFAULT,
                                                   HEAD_DIM_QK, HEAD_DIM_VO, MASK_MODE,
                                                   AttentionVariant, PersistentParams>(smem_size,
                                                                                       num_threads);
...
void BatchPagedAttentionRun(TensorView float_workspace_buffer, TensorView int_workspace_buffer,
  ...
  DISPATCH_context(
      ...
      AttentionVariant, PersistentParams, [&] {
        ...
        cudaError_t status =
            BatchPagedAttentionPersistent<CTA_TILE_Q_1_DEFAULT, CTA_TILE_Q_2_DEFAULT, HEAD_DIM_QK,
